...
public interface BusOperatorI extends JpaRepository<BusOperator, Integer> {
	...
	public List<Booking> findMonthlyRevenueByBusRouteRouteName(@Param("routeName") String routeName,@Param("month") int month);
	...
	public List<Booking> getRevenueByBusRouteAndDate(@Param( "routeName")String routeName,@Param("date")LocalDate date);
